...
public class RepeatedTests {
    ...
    @RepeatedTest(value = 3, name = "Running repetions : {currentRepetition}," +
    ...
    void thirdRepeatedMethod(RepetitionInfo repetitionInfo){
        ...
        Assumptions.assumingThat(repetitionInfo.getCurrentRepetition()==3,()-> System.out.println("This code run in repetion 3"));
    }
